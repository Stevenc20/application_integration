...
class ChartController extends Controller
{
    ...
    {
        // Ambil tanggal terakhir dari SinglePart untuk kategori FINISH PART
        $latestDate = SinglePart::where('category', 'FINISH PART')->orderBy('id', 'desc')->value('sheet_date');
        
        $query = SinglePart::where('category', 'FINISH PART');
        if ($latestDate) {
