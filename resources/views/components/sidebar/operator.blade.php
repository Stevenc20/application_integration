@php
    $dashboardActive = request()->routeIs('operator.dashboard') || request()->routeIs('supervisor.dashboard');
...
<ul class="list-none space-y-1 m-0 p-0">
    ...
    <li class="menu-item relative">
        ...
        <ul class="list-none ml-9 mt-1 space-y-1 {{ $dashboardActive ? '' : 'hidden' }} menu-sub">
            <li>
                <a href="{{ route('operator.dashboard') }}" class="block px-3 py-2 text-sm rounded-lg transition {{ request()->routeIs('operator.dashboard') ? 'bg-red-600 text-white font-medium' : 'text-gray-500 hover:bg-gray-100 hover:text-red-600' }}">
                    Dashboard Overview
                </a>
            </li>
