...
<ul class="list-none space-y-1.5 m-0 p-0">
    ...
    <li class="menu-item relative">
        <a href="javascript:void(0);" role="button" aria-expanded="false" aria-label="Toggle Menu Dashboards" class="menu-toggle flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 {{ ($dashboardActive || $lineDashboardActive) ? 'bg-red-50 text-primary-red' : 'text-gray-600 hover:bg-gray-50' }}">
    ...
    <li class="menu-item relative">
        <a href="javascript:void(0);" role="button" aria-expanded="false" aria-label="Toggle Menu Master Data" class="menu-toggle flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 {{ $masterActive ? 'bg-red-50 text-primary-red' : 'text-gray-600 hover:bg-gray-50' }}">
            <div class="flex items-center gap-3">
    ...
    <li class="menu-item relative">
        <a href="javascript:void(0);" role="button" aria-expanded="false" aria-label="Toggle Menu Operasional" class="menu-toggle flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 {{ $operasionalActive ? 'bg-red-50 text-primary-red' : 'text-gray-600 hover:bg-gray-50' }}">
            <div class="flex items-center gap-3">
        ...
        <ul class="list-none ml-9 mt-1 space-y-1 {{ $operasionalActive ? '' : 'hidden' }} menu-sub">
            ...
            @endif
            @if(auth()->user()->isRole(['admin', 'superadmin']) && auth()->user()->hasFeature('network_monitor'))
            <li>
            ...
            @endif
            @if(auth()->user()->isRole(['admin', 'superadmin']) && auth()->user()->hasFeature('security'))
            <li>
    ...
    <li class="menu-item relative">
        <a href="javascript:void(0);" role="button" aria-expanded="false" aria-label="Toggle Menu Monitoring & Analisis" class="menu-toggle flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 {{ $monitoringActive ? 'bg-red-50 text-primary-red' : 'text-gray-600 hover:bg-gray-50' }}">
            <div class="flex items-center gap-3">
    ...
    <li class="menu-item relative">
        <a href="javascript:void(0);" role="button" aria-expanded="false" aria-label="Toggle Menu Audit & Management" class="menu-toggle flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 {{ $auditActive ? 'bg-red-50 text-primary-red' : 'text-gray-600 hover:bg-gray-50' }}">
            <div class="flex items-center gap-3">
    ...
    <li class="menu-item relative">
        <a href="javascript:void(0);" role="button" aria-expanded="false" aria-label="Toggle Menu Report" class="menu-toggle flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 {{ $reportActive ? 'bg-red-50 text-primary-red' : 'text-gray-600 hover:bg-gray-50' }}">
            <div class="flex items-center gap-3">
        ...
        <ul class="list-none ml-9 mt-1 space-y-1 {{ $reportActive ? '' : 'hidden' }} menu-sub">
            ...
            <li><a href="{{ route('supervisor.reports.asakai') }}" class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg transition {{ request()->routeIs('supervisor.reports.asakai') ? 'bg-red-600 text-white font-medium' : 'text-gray-500 hover:bg-gray-100 hover:text-red-600' }}"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg><span>ASAKAI</span></a></li>
