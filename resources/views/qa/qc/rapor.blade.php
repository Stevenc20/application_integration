    ...
    <div class="max-w-6xl mx-auto pb-12">
        ...
        <div class="bg-slate-900 text-white p-8 border-b-4 border-rose-700 shadow-sm mb-8 flex flex-col md:flex-row justify-between md:items-end gap-6">
            ...
            <div class="text-left md:text-right">
                ...
                <form method="GET" action="{{ route('qa.qc.rapor') }}" class="flex items-center gap-2">
                    @php
                    ...
                    @if(request()->has('month'))
                        <a href="{{ route('qa.qc.rapor') }}" class="bg-slate-700 hover:bg-slate-600 text-white p-2 rounded-lg transition-colors" title="Reset Filter">
