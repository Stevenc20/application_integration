...
@section('title', 'Quality Achievement Dashboard')
@section('header_title', 'Quality Achievement Dashboard')
...
<div class="space-y-5 min-w-0 space-wrapper">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-gray-200 rounded-2xl px-5 py-4 sm:px-8 sm:py-5 shadow-sm border-l-4 border-l-red-400">
        <div>
            <h1 class="dash-h1 text-base sm:text-xl lg:text-2xl 2xl:text-3xl font-black text-gray-800 uppercase tracking-wide leading-tight">Quality Achievement Dashboard</h1>
