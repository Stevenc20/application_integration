...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200">
        <h5 class="text-lg font-bold text-gray-800">Production Planning</h5>
    </div>
    <div class="p-12 text-center">
        ...
        <p class="text-gray-500 max-w-md mx-auto">Fitur Production Planning untuk Supervisor masih dalam tahap pengembangan. Silakan kembali lagi nanti.</p>
        <div class="mt-6">
