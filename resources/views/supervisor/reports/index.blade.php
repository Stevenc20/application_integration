...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200">
        <h5 class="text-lg font-bold text-gray-800">Laporan Produksi</h5>
    </div>
    <div class="p-12 text-center">
        <div class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-purple-100 text-purple-600 mb-4">
            <i class="bx bx-file text-4xl"></i>
        </div>
        <h3 class="text-xl font-bold text-gray-800 mb-2">Modul Sedang Dalam Pengembangan</h3>
        <p class="text-gray-500 max-w-md mx-auto">Fitur Laporan untuk Supervisor masih dalam tahap pengembangan. Silakan kembali lagi nanti.</p>
        <div class="mt-6">
