...
class MasterStampingController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            if (!$sheet) {
                return back()->with('error', 'Sheet MASTER tidak ditemukan di file Excel.');
            }

            // Load Shift Pagi and Shift Malam list sheets (Sheet1 and Sheet2 reference sheets)
            $sheetShift1 = $spreadsheet->getSheetByName('master untuk shift 1');
            $sheetShift2 = $spreadsheet->getSheetByName('master untuk shift 2');
