...
class ImportPrices extends Command
{
    ...
    protected $description = 'Import price_pc dari ADD.xlsx ke tabel rundown_incomings dan recalculate all_price';
...
PYEOF;
        ...
        $allRows = RundownIncoming::select('id', 'job_no', 'stok_akhir', 'price_pc', 'customer', 'cycle_issue', 'movement')->get();
